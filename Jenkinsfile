      ...
      steps {
          withCredentials ([azureServicePrincipal('6733829c-3f4f-49c5-a2f8-536f17e2cf59')])
            ...
            sh '''
                ...
                export ANSIBLE_HOST_KEY_CHECKING=False; ansible-playbook -i ansible/inventory ansible/sig.yml -e '{"shared_image_name":"${IMAGE_NAME}", "shared_image_version":"${version}"}'
